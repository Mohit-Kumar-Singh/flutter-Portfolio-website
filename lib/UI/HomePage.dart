...
import 'package:potrtfolio/UI/Eductaion.dart';
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Wrap(
                                    children: [
                                      Text(
                                        "An enthusiastic and hardworking undergraduate willing  to \nlearn and explore the field of Computer Science..",
                                        style: TextStyle(
                                          color: Colors.grey,
                                          fontSize: 16.0,
                                          letterSpacing: 2.75,
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      //color: Colors.white,
                                      child: Text(
                                        "Designed & Built by Mohit 💙 Flutter",
                                        style: TextStyle(
                      ...
                      children: [
                        RotatedBox(
                          ...
                          child: InkWell(
                            onTap: () {
                              method
                                  .launchURL("mailto:mohit1911048@akgec.ac.in");
                            },
                            child: Text(
